...
# @bot.callback_query_handler(func=lambda call: True)
# def callback_func_2(query):
#     global value, old_value
#     bot.edit_message_text(chat_id=query.message.chat.id, message_id=query.message.message_id, text= '0000000000', reply_markup=keyboard)
#     data = query.data
